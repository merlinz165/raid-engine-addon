...
assert.deepEqual(luaFiles.sort(), ['RaidEngine.lua', 'RaidEngine_Contract.lua', 'RaidEngine_Json.lua', 'RaidEngine_Loadout.lua', 'RaidEngine_Plan.lua', 'RaidEngine_Timeline.lua']);
...
for (const file of ['RaidEngine_Contract.lua', 'RaidEngine_Loadout.lua', 'RaidEngine_Plan.lua', 'RaidEngine_Timeline.lua']) {
